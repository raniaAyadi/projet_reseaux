...
import peer.distribution.NeighbourdRequest;
...
public class RequestFactory {
	...
	public static Request createRequest(String in, InetAddress add) throws ProtocolException{
		char x = in.charAt(0);
		String className;
		...
		case 'b' : className = NeighbourdRequest.class.getName();
		break;
		...
		Constructor ct;
		try {
			ct = c.getConstructor(String.class, InetAddress.class);
		...
		try {
			return (Request)ct.newInstance(in, add);
