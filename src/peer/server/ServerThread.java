...
public class ServerThread implements Runnable {
	...
	public ServerThread(Socket socket, Integer numClient) throws IOException{
		...
		this.log.log(Level.CONFIG,this+ "is connected");
	}
	...
	private Request receive() throws IOException, ProtocolException{
		...
		Request req = RequestFactory.createRequest(message, socket.getInetAddress());
		if(req == null) {
	...
	private void disconnect(){
		...
		log.log(Level.CONFIG, this + " has disconnected");
	}
